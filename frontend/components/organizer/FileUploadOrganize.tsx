				...
				<div className='flex items-start gap-4'>
					...
					<div>
						...
						<p className='text-gray-700 dark:text-gray-300 mb-2'>
							Rotate, delete, and reorder pages in your PDF.
							Perfect for fixing scanned documents or removing
							unwanted pages.
						</p>
						<ul className='text-sm text-gray-600 dark:text-gray-400 space-y-1'>
							<li>
								• <strong>Rotate</strong> – Fix sideways or
								upside-down pages
							</li>
							<li>
								• <strong>Delete</strong> – Remove unwanted
								pages
							</li>
							<li>
								• <strong>Reorder</strong> – Drag and drop to
								rearrange pages
							</li>
						</ul>
					</div>
